...
tourn1 = Tournament.create(title: "1st Tournament Tutorial", author_id: user3.id, description: "Welcome to the first tournament ever hosted on TournaGen! This is an example of a tournament starting from scratch. Take a look around!", max_teams: 32, results: tourn1_results)
...
foll1 = Follow.create(tournament_id: tourn2.id, follower_id: user1.id)
